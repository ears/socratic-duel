...
5. **Live Dialectical Debate UI (Phase 2/3)**: During the execution of the debate loop, the frontend must visually display the ongoing back-and-forth arguments between the Protagonist and the Antagonist. The user must be able to "read along" and observe the dialectical friction and logic in real-time before the final synthesized report is produced.

...
deploy:
	...
	@gcloud run services add-iam-policy-binding socratic-duel-demo --region=us-east1 --member=allUsers --role=roles/run.invoker --quiet
...
undeploy:
	...
	@echo "--- Removing Cloud Run Service 'socratic-duel-demo'..."
	gcloud run services delete socratic-duel-demo --region=us-east1 --quiet

...
The format is based on [Keep a Changelog](https://keepachangelog.com/en/1.0.0/), but adapted for non-technical readability.
This project uses a two-digit major/minor versioning system (e.g., `1.00`, `1.01`).

## [Unreleased]
*This section tracks upcoming changes that haven't been tagged yet.*
